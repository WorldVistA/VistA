...
PACKAGE_MAP = {
    ...
    'MCCR NATIONAL DATABASE' : 'MCCR National Database - Field',
    'MEDICATION ORDER CHECK (MOCHA)' : 'Medication Order Check Healthcare Application',
    ...
    "NAT'L UTILIZATION MGMT INTEG" : 'National Utilization Management Integration',
    ...
    #  u'PATIENT FILE',
    #  u'PROGRESS NOTES',
    'QUALITY ASSURANCE' : 'Quality Assurance Integration',
    #  u'QUALITY IMPROVEMENT CHECKLIST',
    #  u'REAL TIME LOCATION SYSTEM',
    'RELEASE OF INFORMATION - DSSI' : 'Release Of Information',
    ...
    'WIRELESS MEDICATION ADMIN': 'Wireless Medication Administration'
