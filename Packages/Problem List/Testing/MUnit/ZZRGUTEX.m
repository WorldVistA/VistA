...
RORLO ;
 ...
 D CHKTF^XTMUNIT(ROR("OBR","DIAG")[$P(ACTDIA,U,2),"ICD9")
...
PXRMOUT ;
 ...
 D CHKTF^XTMUNIT($D(TEXT(NARRLOC)),"Provider narrative not defined")
 D CHKEQ^XTMUNIT(" Hypopituitarism",$G(TEXT(NARRLOC)))
 ; This information doesnt seem to exist in new output....
 I NARRLOC=12 D CHKEQ^XTMUNIT(" PANHYPOPITUITARISM",$G(TEXT(4)))
 Q
 ;
PXRMPRB ;
