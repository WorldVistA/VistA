...
API2DET ;
 ...
 D CHKTF^XTMUNIT(RETURN(1.04)["USER")
 D CHKTF^XTMUNIT(RETURN(1.05)["USER")
...
API2DETX ;
 ...
 D CHKTF^XTMUNIT(RETURN("COMMENT",1),DTF_"^")
 D CHKTF^XTMUNIT(RETURN("COMMENT",1),"USER")
 D CHKTF^XTMUNIT(RETURN("COMMENT",1),"^TEST COMMENT")
 ...
 D CHKTF^XTMUNIT(RETURN("PROVIDER")["USER")
 D CHKTF^XTMUNIT(RETURN("RECORDED")["3/6/12^")
 D CHKTF^XTMUNIT(RETURN("RECORDED")["USER")
