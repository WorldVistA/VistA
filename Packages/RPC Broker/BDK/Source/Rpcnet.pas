...
begin
   ...
   chrTemp := PAnsiChar(StrAlloc(512));  // JLI 090804 OSE/SMH
   ...
   If  WSAError < 0 then
   begin
        chrTemp := PAnsiChar(AnsiString(IntToStr(WSAError)));    //p60 OSE/SMH
        exit;
   end;
   ...
   except on EInValidPointer do AnsiStrings.StrCat(chrTemp, 'Error in GetHostByName');      //p60
   end;
end;
end;
