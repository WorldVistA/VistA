...
begin  {BODY }
  ...
  alist.add('NEW' + v + '80201' + v + Piece(FloatToStr(EncounterDate, TFormatSettings.Create('en-US')),'.',1) + u + FormatFMDateTime('yyyy/mm/dd',EncounterDate));   {Code Date/Date of Interest}
