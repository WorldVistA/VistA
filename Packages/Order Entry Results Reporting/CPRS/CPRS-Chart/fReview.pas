...
begin
  ...
  y := 0;
  // capture heights before aligns adjust them
  y1 := pnlTop.Height;
  y2 := pnlReview.Height;
  y3 := pnlCSReview.Height;
  ...
  if y > 0 then
  begin
    Constraints.MinHeight := Constraints.MinHeight - y;
    Height := Height - y;
  end;
                    ...
                    if ((Patient.Inpatient = False) and (tempInpLoc <> '')) or
                      ...
                      begin
                        ...
                        if (OrderPrintList.Count > 0) and (DelayOnly = False) then
                          ...
                          begin
                            TfrmPrintLocation.SwitchEncounterLoction(EncLocIEN, EncLocName, EncLocText, EncDT, EncVC);
