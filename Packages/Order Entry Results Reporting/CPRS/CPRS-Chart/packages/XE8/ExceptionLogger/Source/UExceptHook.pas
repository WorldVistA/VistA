...
procedure HookedRaiseExceptionProc(ExceptionCode, ExceptionFlags: Longword;
...
begin
  try
          ...
          begin
            ...
            if ExceptionHook.ProcessingAV then
              ExceptionObj.SetStackInfo
                (ExceptionHook.SetupNoTraceStack(ArgsArry[0], ArgsArry[5]))
            else
              ExceptionObj.SetStackInfo(ExceptionHook.SetupStack(ArgsArry[0],
                ArgsArry[5]));
          end;
        end;
      cNonDelphiException:
        begin
          ...
          if ExceptionHook.ProcessingAV then
            ExceptionObj.SetStackInfo
              (ExceptionHook.SetupNoTraceStack(ContextRecord))
          else
    ...
    try
      fOrigRaiseExceptionProc(ExceptionCode, ExceptionFlags,
