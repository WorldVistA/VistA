...
procedure SortByPieces(AList: TStringList; ADelim: Char; PieceNums: tSortArray; aSortDir: tSortDir = DIR_FRWRD);
...
begin
 ...
 begin
  ...
  LastPos := Pos(' ' + ExcludeFromMixed[i], X);
  while LastPos <> 0 do
  begin
   ...
   LastPos := Pos(' ' + ExcludeFromMixed[i], X, LastPos + 1);
  end;
 end;
