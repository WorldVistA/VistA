...
type
  ...
  public
    ...
    class function Show(const Text, Caption: string; DlgType: TMsgDlgType;
      ...
      ButtonCaption: TArray<string> = [];
      ButtonOnClick: TArray<TNotifyEvent> = []): integer; overload;

    class function Show(const Text, Caption: string; DlgType: TMsgDlgType;
      ModalResults: array of integer; const Features: TFeatures;
      out Output: TOutput; ButtonCaption: TArray<string> = [];
      ButtonOnClick: TArray<TNotifyEvent> = []): integer; overload;
  end;
...
class function TVAInfoDialog.Show(const Text, Caption: string;
  ...
  const Features: TFeatures; ButtonCaption: TArray<string> = [];
  ButtonOnClick: TArray<TNotifyEvent> = []): integer;
var
  Output: TOutput;
begin
...
class function TVAInfoDialog.Show(const Text, Caption: string;
  ...
  ButtonCaption: TArray<string> = []; ButtonOnClick: TArray<TNotifyEvent> = []
  ): integer;
const
