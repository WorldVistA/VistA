...
interface
function GetFileCrc32(FileName: string): string;
...
var
  ...
  TempResult: LongInt;
begin
//  TempResult := $FFFFFFFF; zzzzzzandria 2007-07-17 commented out
  TempResult := -1;
