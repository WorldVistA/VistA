...
procedure HotFixError; //Generates messagedlg regarding needed Windows Update.
...
begin
  ...
  try
    ...
    if (not LoadLocalHelp(HelpFile, LocalHelpFile)) and (not FCanceled) then
      ...
      Application.MessageBox('Error while trying to open "Thin Client" help.',
        'Help File', MB_ABORTRETRYIGNORE + MB_ICONSTOP) of
        IDABORT:
          begin
