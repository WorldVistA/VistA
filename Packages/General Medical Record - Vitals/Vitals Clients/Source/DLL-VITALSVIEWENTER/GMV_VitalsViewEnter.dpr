...
function LatestVitalsList(const aBroker:TRPCBroker;
        aPatient,aDelim:String;bSilent:Boolean):TStringList;export;stdcall;
var
...
//  ,setTimeOut           name 'GMV_VitalsTimeOut'
  ;
