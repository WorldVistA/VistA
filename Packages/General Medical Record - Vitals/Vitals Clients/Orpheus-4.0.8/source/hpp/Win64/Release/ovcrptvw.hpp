...
protected:
	...
	System::UnicodeString __fastcall GetStringAtPos(System::Types::TPoint XY);
...
_DECLARE_METACLASS(System::TMetaClass, TOvcReportViewClass);
...
public:
	...
	void * __fastcall ItemAtPos(System::Types::TPoint Pos);
