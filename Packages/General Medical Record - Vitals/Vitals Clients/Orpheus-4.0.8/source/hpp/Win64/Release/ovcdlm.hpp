...
{
public:
	System::StaticArray<System::Byte, 4088> Data;
...
typedef System::StaticArray<void *, 507> TOvcPTDataArray;
...
static const System::Word dlmMaxItemSize = System::Word(0xff8);
static const System::Word EntriesPerPage = System::Word(0x1fb);
