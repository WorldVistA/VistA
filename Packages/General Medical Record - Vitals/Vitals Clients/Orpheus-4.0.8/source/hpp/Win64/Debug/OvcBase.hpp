...
_DECLARE_METACLASS(System::TMetaClass, TOvcCollectibleClass);

_DECLARE_METACLASS(System::TMetaClass, TO32CollectibleClass);
...
public:
	...
	void __fastcall Popup(System::Types::TPoint P);
