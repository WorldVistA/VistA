...
class CustomInstaller(DefaultKIDSBuildInstaller):
  ...
  def __handleKIDSInstallQuestions__(self, connection, connection2=None):
    ...
    kidsMenuActionLst.append(("Enter the PORT Number for the MPINEWPSIMEXECUTE web service","1",False))
    kidsMenuActionLst.append(("Enter the name of the server for MPINEWPSIMEXECUTE","127.0.0.1",False))
    while True:
